...
当使用 superpowers 完成计划的实现后，必须将对应的 design 和 plan 文档文件名开头加上 `done-` 前缀标记为已完成。

示例：
- `2026-05-16-jacc-plan1-scaffold.md` → `done-2026-05-16-jacc-plan1-scaffold.md`
- `2026-05-16-jacc-claude-config-gui-design.md` → `done-2026-05-16-jacc-claude-config-gui-design.md`
