...
export const sidebar = tv({
  slots: {
    ...
    sectionTitleSpaced: 'px-3 py-1 mt-3 text-[10px] text-muted uppercase tracking-wider',
    navItem: 'w-[calc(100%-16px)] text-left px-4 py-[7px] mx-2 text-xs flex items-center gap-2 rounded-[4px] cursor-pointer',
