...
import { AddModelDialog } from '@/features/models/components/AddModelDialog'
import { AddApiKeyDialog } from '@/features/models/components/AddApiKeyDialog'
    ...
    <div>
      ...
      {expanded && (
        <div className="mt-0.5 mb-1 flex flex-col gap-0.5">
          ...
          {models.length === 0 && <div className="pl-24 pr-3 py-2 text-[11px] text-muted">{t('models.empty')}</div>}
        </div>
      )}
    ...
    <div className="bg-card border border-border-light rounded-[4px]">
      ...
      {expanded && (
        <div className="pb-2 flex flex-col gap-0.5">
          ...
          {apiKeys.length === 0 && <div className="pl-12 pr-3 py-2 text-[11px] text-muted">{t('models.empty')}</div>}
        </div>
      )}
