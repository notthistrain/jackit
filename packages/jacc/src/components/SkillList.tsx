...
import { InstallSkillDialog } from '@/features/skills/components/InstallSkillDialog'
      ...
      <div className="flex items-center gap-4 mb-4">
        <button
          ...
          className={`text-sm font-medium pb-1 border-b-2 transition-colors ${
            tab === 'enabled' ? 'text-foreground border-primary' : 'text-muted border-transparent hover:text-foreground'
          }`}
        >
